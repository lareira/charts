...
{{- default (include "homepage.fullname" .) .Values.rbac.name }}
{{- else }}
...
*/}}
{{- define "homepage.clusterRoleBindingName" -}}
{{- if .Values.rbac.create }}
{{- default (include "homepage.fullname" .) .Values.rbac.bindingName }}
{{- else }}
{{- default "default" .Values.rbac.bindingName }}
{{- end }}
{{- end }}
